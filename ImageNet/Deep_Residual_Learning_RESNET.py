...
"""
Lasagne implementation of IMAGENET examples from "Deep Residual Learning for Image Recognition" (http://arxiv.org/abs/1512.03385)
...
# this code assumes the imagenet data has been downloaded
...
def load_data():
    ...
    ys = []
    for j in range(1):
      d = unpickle('data32x32/train_data_batch_'+ str(j+1))
      x = d['data']
      y = d['labels']
      y = [i-1 for i in y]
      xs.append(x)
